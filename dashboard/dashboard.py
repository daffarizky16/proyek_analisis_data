...
with st.sidebar:
    ...
    st.header("Daffline")
    st.image("https://cdn-icons-png.freepik.com/256/6137/6137587.png?ga=GA1.1.1101376010.1736700108&semt=ais_hybrid", width=150)
...
st.caption('Copyright (c) belajar di Dicoding 2025')